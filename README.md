...
> This project is for practice on ROR framework.

**[Hello Rails Project]** is a ROR framework practice.
...
```sh
  cd hellorails
  git clone https://github.com/storres20/hellorails.git
```
...
Feel free to check the [issues page](https://github.com/storres20/hellorails/issues).
